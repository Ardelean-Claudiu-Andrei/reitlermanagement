...
export const parts: Part[] = [
  {
    id: "part1", name: "Steel Plate 10mm",
    description: { ro: "Placă de oțel 10mm", hu: "10mm acéllemez", de: "10mm Stahlplatte", en: "10mm Steel Plate" },
    fileName: "steel_plate_10mm.dxf", fileLocation: "/laser/plates/steel/",
    unit: "pcs", basePrice: 45.0, category: "Metal", minimumStock: 5, quantity: 20, location: "Shelf A1", notes: "",
    createdAt: "2025-01-10", updatedAt: "2026-02-10",
  },
  {
    id: "part2", name: "Steel Rod 8mm",
    description: { ro: "Bară de oțel 8mm", hu: "8mm acélrúd", de: "8mm Stahlstab", en: "8mm Steel Rod" },
    fileName: "steel_rod_8mm.dxf", fileLocation: "/laser/rods/",
    unit: "m", basePrice: 12.5, category: "Metal", minimumStock: 10, quantity: 50, location: "Shelf A2", notes: "",
    createdAt: "2025-01-12", updatedAt: "2026-02-08",
  },
  {
    id: "part3", name: "Aluminum Sheet 5mm",
    description: { ro: "Foaie de aluminiu 5mm", hu: "5mm alumínium lemez", de: "5mm Aluminiumblech", en: "5mm Aluminum Sheet" },
    fileName: "alu_sheet_5mm.dxf", fileLocation: "/laser/plates/aluminum/",
    unit: "pcs", basePrice: 32.0, category: "Metal", minimumStock: 5, quantity: 15, location: "Shelf B1", notes: "",
    createdAt: "2025-01-15", updatedAt: "2026-02-12",
  },
  {
    id: "part4", name: "M10 Bolt Set",
    description: { ro: "Set șuruburi M10", hu: "M10 csavarkészlet", de: "M10 Schraubensatz", en: "M10 Bolt Set" },
    fileName: "", fileLocation: "",
    unit: "set", basePrice: 3.5, category: "Fasteners", minimumStock: 20, quantity: 100, location: "Bin C1", notes: "",
    createdAt: "2025-01-18", updatedAt: "2026-02-15",
  },
  {
    id: "part5", name: "M12 Bolt Set",
    description: { ro: "Set șuruburi M12", hu: "M12 csavarkészlet", de: "M12 Schraubensatz", en: "M12 Bolt Set" },
    fileName: "", fileLocation: "",
    unit: "set", basePrice: 4.2, category: "Fasteners", minimumStock: 20, quantity: 80, location: "Bin C2", notes: "",
    createdAt: "2025-01-20", updatedAt: "2026-02-14",
  },
  {
    id: "part6", name: "Welding Wire 1.2mm",
    description: { ro: "Sârmă de sudură 1.2mm", hu: "1.2mm hegesztőhuzal", de: "1.2mm Schweißdraht", en: "1.2mm Welding Wire" },
    fileName: "", fileLocation: "",
    unit: "kg", basePrice: 8.0, category: "Consumables", minimumStock: 5, quantity: 25, location: "Shelf D1", notes: "",
    createdAt: "2025-01-22", updatedAt: "2026-02-11",
  },
  {
    id: "part7", name: "Industrial Paint RAL 7035",
    ...
    fileName: "", fileLocation: "",
    unit: "L", basePrice: 22.0, category: "Consumables", minimumStock: 3, quantity: 2, location: "Shelf D2", notes: "",
    createdAt: "2025-01-25", updatedAt: "2026-02-09",
  },
  {
    id: "part8", name: "Silo Wall Panel",
    description: { ro: "Panou perete siloz", hu: "Siló falpanel", de: "Silo-Wandpaneel", en: "Silo Wall Panel" },
    fileName: "silo_wall_panel.dxf", fileLocation: "/laser/silo/walls/",
    unit: "pcs", basePrice: 120.0, category: "Silo", minimumStock: 2, quantity: 8, location: "Warehouse E1", notes: "",
    createdAt: "2025-02-01", updatedAt: "2026-02-16",
  },
  {
    id: "part9", name: "Silo Roof Segment",
    description: { ro: "Segment acoperiș siloz", hu: "Siló tetőszegmens", de: "Silo-Dachsegment", en: "Silo Roof Segment" },
    fileName: "silo_roof_segment.dxf", fileLocation: "/laser/silo/roof/",
    unit: "pcs", basePrice: 85.0, category: "Silo", minimumStock: 2, quantity: 5, location: "Warehouse E2", notes: "",
    createdAt: "2025-02-05", updatedAt: "2026-02-17",
  },
  {
    id: "part10", name: "Control Panel Housing",
    description: { ro: "Carcasă panou control", hu: "Vezérlőpanel ház", de: "Schaltschrankgehäuse", en: "Control Panel Housing" },
    fileName: "control_panel_housing.dxf", fileLocation: "/laser/enclosures/",
    unit: "pcs", basePrice: 180.0, category: "Electrical", minimumStock: 1, quantity: 3, location: "Shelf F1", notes: "",
...
export const usersWithInfo: UserWithInfo[] = [
  {
    user: { id: "u1", firstName: "Claudiu", lastName: "Ardelean", name: "Claudiu Ardelean", email: "claudiu.ardelean@smsreitler.com", status: "active" },
    additionalInformation: { userId: "u1", role: "admin", type: "admin" },
  },
  {
    user: { id: "u2", firstName: "Radu", lastName: "Muresan", name: "Radu Muresan", email: "radu.muresan@smsreitler.com", status: "active" },
    additionalInformation: { userId: "u2", role: "admin", type: "admin" },
  },
  {
    user: { id: "u3", firstName: "Maria", lastName: "Ionescu", name: "Maria Ionescu", email: "maria.ionescu@smsreitler.com", status: "active" },
    additionalInformation: { userId: "u3", role: "employee", type: "employee" },
  },
  {
    user: { id: "u4", firstName: "Ion", lastName: "Popescu", name: "Ion Popescu", email: "ion.popescu@smsreitler.com", status: "active" },
    additionalInformation: { userId: "u4", role: "employee", type: "employee" },
  },
  {
    user: { id: "u5", firstName: "Ana", lastName: "Dobre", name: "Ana Dobre", email: "ana.dobre@smsreitler.com", status: "inactive" },
